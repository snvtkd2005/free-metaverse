<template>
    <div ref="cameraPanel" id="cameraPanel" style="position: absolute;z-index:-10;" class="cameraPanel overflow-hidden  ">
    ...
    <div v-if="mask" class=" absolute z-50 left-0 top-0 w-full h-full flex   " @click="addListenFn">
        <div class=" absolute bottom-0 h-20 w-full self-center mx-auto  text-gray-800">
    ...
    methods: {
        ...
        onDeviceOrientationChangeEvent(e) {
            ...
            orient.alpha = e.alpha;
              ...
              if (orient.beta >= this.upView) { orient.beta = this.upView; } //仰角限制
            if (orient.beta <= this.downView) { orient.beta =  this.downView; } //俯角限制
