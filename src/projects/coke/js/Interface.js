...
class Interface {
  ...
  constructor(_this) {
    ...
    this.BeginAgineGame = function () {
      ...
      // _this.$refs.YJmetaBase.ThreejsHumanChat._YJSceneManager.GetAmmo().SetEnabled(true);
      // setTimeout(() => {
      //   _this.$refs.YJmetaBase.ThreejsHumanChat._YJSceneManager.GetAmmo().SetEnabled(false);
      // }, 200);
