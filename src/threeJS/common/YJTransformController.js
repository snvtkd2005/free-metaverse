  ...
  constructor(scene, renderer, camera) {
    ...
    function InitTransformController() {
      if (_Global.YJ3D.YJRaycaster) {
        _Global.YJ3D.YJRaycaster.addEventListener('hover', (hoverObj, point) => {
      ...
      transformController.addEventListener('dragging-changed', function (event) {
        if (_Global.YJ3D.YJController) {
          _Global.YJ3D.YJController.enabled = !event.value;
        }
    ...
    this.onKeyDown = function (event) {
      ...
      switch (event.keyCode) {
        ...
        case 70: // F
          //
          // console.log(" click F ");
          _Global.YJ3D._YJSceneManager.SetPlayerPosDirect(selectMesh.position.clone());
          break;
        case 71: // G
          //
          // console.log(" click G ");
          selectMesh.position.copy(_Global.YJ3D._YJSceneManager.GetPlayerPosReduceHeight());
          break;
        case 82: // R
