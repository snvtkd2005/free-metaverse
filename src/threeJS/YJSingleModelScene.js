...
class YJSingleModelScene {
  constructor(container, _this) {
    ...
    function Init() {
      ...
      // this.LoadStaticModel("./public/SingleModel/models/Scene/");
    }
    //初始化第三人称控制器
    ...
    this.LoadStaticModel = function (modelPath,modelName, callback) {
