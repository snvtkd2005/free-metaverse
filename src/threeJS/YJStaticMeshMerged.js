  ...
  constructor(_this, scene, model, modelData, callback) {
    ...
    model.traverse(function (item) {
      ...
      if (item.isMesh && item.name.includes("collider")) {
        ...
        //把第一个模型的碰撞删除
        _this._YJSceneManager.GetAmmo().removeRigidBody(item);
    ...
    function makeMergedCollider() {
      ...
      _this._YJSceneManager.GetAmmo().CreateTriangeMeshColliderConcave(colliderMergedMesh);
    ...
    this.Click = function (index) {
      ...
      if (colliderMergedMesh != null) {
        _this._YJSceneManager.clearObject(colliderMergedMesh);
      }
