...
export default {
  ...
  data() {
    return {
      ...
      selectProjectName: "revelya",
      selectProjectPath: "",
      projectList: [
        {
          value: "farm",
          // serverPath: "farm/test/",
          serverPath: "farm2/models/",
        },
        {
          value: "city",
          serverPath: "city/models/",
        },
        {
          value: "revelya",
          serverPath: "revelya/models/",
        },
        {
          value: "revelya2",
          serverPath: "revelya2/models/",
        },
        {
          value: "Test",
          serverPath: "Test/models/",
        },
        {
          value: "EastArt",
          serverPath: "EastArt/models/",
        },
      ],
  ...
  mounted() {
    ...
    // this.publicUrl = "C:/wamp/www/vue/dt/public/";
    this.publicUrl = "C:/inetpub/wwwroot/vue/dt/public/";
