...
export default {
  ...
  setting: {
    ...
    hasEnvmap: true,
    // 天空球全景图路径
    // envmapPath: "envmap.png",
    // envmapPath: "11.hdr",
    envmapPath: "sky_linekotsi_03_HDRI.exr",
    ...
    // 摄像机上下旋转的限制弧度
    // targetRota:{x:-1.25,y:1.3}, //第一人称限制参数
    targetRota:{x:-1.05,y:0.13}, //第三人称限制参数
  ...
  aerialViewData: {
    // 鸟瞰摄像机位置
    niaokanCamPos: { x: -419, y: 50, z: -75 },
    // 鸟瞰时摄像机lookat坐标
    niaokanCamLookatPos: { x: 1, y: -62, z: 0 },
  },
  ...
  playerPosPath: "models/Scene/playerPosList.txt",
  ...
  avatarData: [
    {
      ...
      modelType: "角色",
      modelPath: "player/girl.fbx",
      animationsData: [
        { clipIndex: 0, animName: "idle", timeScale: 1, connected: false, targetIndex: 2 },
