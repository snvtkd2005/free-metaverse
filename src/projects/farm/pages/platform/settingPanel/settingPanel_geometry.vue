...
export default {
  ...
  data() {
    return {
      ...
      {
          property: "geometryType", display: true, title: "几何体类型", type: "drop", value: "sword", options: [
            { value: "box", label: "Box" }, 
      ...
      //   { property: "speed", display: true, title: "默认X轴播放速度", type: "slider", value: 1, min: 0, max: 5, step: 0.5, callback: this.ChangeValue },
        { property: "isCollider", display: true, title: "is collider", type: "toggle", value: false, callback: this.ChangeValue },
        { property: "isTrigger", display: true, title: "is trigger", type: "toggle", value: false, callback: this.ChangeValue },
        { property: "tiggerTag", display: true, title: "标签(保证唯一)", type: "text", value: "", callback: this.ChangeValue },
  ...
  methods: {
    ...
    ChangeUIState(property, e) {
      ...
      let isTrigger = this.Utils.GetSettingItemValueByProperty(this.setting, 'isTrigger');
      this.Utils.SetSettingItemPropertyValueByProperty(this.setting, "tiggerTag", "display", isTrigger );
