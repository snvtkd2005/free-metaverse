<template>
  ...
  <div id="userListPanel"
    ...
    <div class=" mt-10 text-left h-auto max-h-96 overflow-y-auto overscroll-auto text-white">
      <div v-for="(item, i) in otherUser" :key="i" :index="item.userName" class=" relative w-11/12  pl-2 border-b-2 flex "
        ...
        <div class=" absolute right-0 z-auto " :class="(isMainUser && item.id != id) ? 'pointer-events-auto cursor-pointer ' : 'pointer-events-none',
  ...
  <div class="
    ...
    <div class="w-full h-auto max-h-80 flex flex-col justify-between relative">
      <div ref="roomChateRecode" class=" w-72  xl:w-full h-auto max-h-72  overscroll-auto">
