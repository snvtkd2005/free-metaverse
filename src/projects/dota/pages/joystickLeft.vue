...
<template>
  ...
  <div id="joystick_left_parent" class=" absolute w-40 h-40 z-50 left-2 bottom-2 flex  pointer-events-none"
    
    >
    <!-- :class="display ? ' opacity-100 ' : ' opacity-0 '" -->

    <div class=" mx-auto w-full h-full flex rounded-full">
      <canvas class="
              self-center
              mx-auto
              rounded-full
...
export default {
  ...
  methods: {
    ...
    CreateJoytick() {
      ...
      // console.log("joystick parent offset one ", left_x, left_y);
    ...
    ResizeJoystick() {
      ...
      // console.error("joystick parent offset two ", left_x, left_y);
