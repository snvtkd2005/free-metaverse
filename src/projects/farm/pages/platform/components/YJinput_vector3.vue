...
<template>
  ...
  <div class=" flex space-x-2">
    ...
    <input class=" w-12" ref="inputX" type="number" :step="step" :value="value[0]"
            @focus="focus"
        @blur="blur">
    <div class=" text-white leading-6">y:</div>

    <input class=" w-12" ref="inputY" type="number" :step="step" :value="value[1]"
            @focus="focus"
        @blur="blur">
    <div class=" text-white leading-6">z:</div>

    <input class=" w-12" ref="inputZ" type="number" :step="step" :value="value[2]"
            @focus="focus"
        @blur="blur"> 
  </div>
</template>
