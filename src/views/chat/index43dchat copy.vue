...
// 在线聊天室 聊天界面 3d形象 聊天
<template>
  <ThreejsHumanChat tabindex="-1" class="absolute left-0 top-0" ref="ThreejsHumanChat" id="ThreejsHumanChat" />
  ...
  <farmInsetPanel ref="farmInsetPanel" v-if="isInsertPanel" />
...
// 加载进度页
import loadingPanel from "/@/views/chat/loadingPanel.vue";

// farm
import AvatarData from "/@/data/playerSelect.js";
// 新农场
// import AvatarData from "/@/data/playerSelectNewFarm.js";
// city
