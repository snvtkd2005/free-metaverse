...
class YJwebsocket {
	constructor(that) {
		...
		function Init() {
			...
			// wsClient = new WebSocket("ws://127.0.0.1:8084/ws");

			// wsClient = new WebSocket("ws://47.104.151.177:8084/ws");
			// wsClient = new WebSocket("ws://www.snvtkd2005.com:8084/ws");
			// wsClient = new WebSocket("wss://www.snvtkd2005.com:8083/ws");
			// wsClient = new WebSocket("ws://www.snvtkd2005.com:8083/ws");
			wsClient = new WebSocket("wss://www.snvtkd2005.com:8084/ws");
			...
			wsClient.onmessage = function (e) {
				...
				//加入新用户的封装，不可更改
				if (msg.indexOf("id=") > -1) {
					console.log("WS客户端接收到服务器消息==》 id = " + msg);
