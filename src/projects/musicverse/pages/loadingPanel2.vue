...
<template>
  ...
  >
    ...
    <!-- 场景加载进度条 -->
  <div v-if="diplayerLoading" class="  absolute w-full h-full top-0 left-0 z-50 flex bg-gray-500  text-white">
    <div class=" absolute left-0 top-0 w-full h-full">
      <img class="  w-full h-full " :src="publicUrl +'loading-bg.jpg' " alt="">
    </div>
