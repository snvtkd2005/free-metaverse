...
class YJ3dScene_playerHeader {
  constructor(container, _this) {
    ...
    function Init() {
      ...
      // let player =  _this.$parent.$refs.YJmetaBase.ThreejsHumanChat.YJPlayer.GetPlayerGroup().clone();
      // console.log(player);
      // scene.add(player);
      // player.position.set(0,0,0);
      let avatarData =  _this.$parent.$refs.YJmetaBase.ThreejsHumanChat.YJPlayer.GetavatarData();
    ...
    function LoadAvatar(modelPath,height, animData) {
      ...
      avatar = new YJLoadAvatar(
        _this.$parent.$refs.YJmetaBase.ThreejsHumanChat,
        scene,
