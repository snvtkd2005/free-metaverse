...
class YJRaycaster  {
  constructor( scene, camera, domElement, clickHit,
    ...
    const raycasterHover = (pos) => {
      ...
      if (scene == null || _Global.YJ3D._YJSceneManager.GetHoverCollider().length == 0) {
        return;
      }
      ...
      try {
        ...
        intersects = raycaster.intersectObjects(
          _Global.YJ3D._YJSceneManager.GetHoverCollider(),
          true
        );
      } catch (error) {
        console.log(error);
