...
export default {
  ...
  methods: {
    ...
    AddVideo(id, html) {
      ...
      if (this.$parent.$parent.AddVideo) {
        this.$parent.$parent.AddVideo(id, html);
      }
    },
    ...
    initScene() {
      ...
      if (this.$parent.$parent.avatarData.setting.hasStats) {
        this.hasStats = this.$parent.$parent.avatarData.setting.hasStats;
      }
    ...
    AddThreeDocumentListener(fn) {
      ...
      this.renderer.domElement.addEventListener("touchstart", fn);
    },
    GetThreeDocument() {
    ...
    GeneratePlayer() {
      ...
      this.YJPlayer = new YJPlayer(
        ...
        (playerObj, playerGroup) => {
          ...
          this._YJSceneManager.CreateMap();
        }
      );
    ...
    renderScene() {
      ...
      this.sceneUpdateId = requestAnimationFrame(this.renderScene);
      ...
      if (timeStamp > singleFrameTime) {
        ...
        // // console.error( ' draw call ', this.renderer.info  );
        // console.log( ' Scene polycount : ', this.renderer.info.render.triangles  );
        // console.log( ' Scene drawcall : ', this.renderer.info.render.calls  );
        // _Global.AddLog("Scene polycount: "+ this.renderer.info.render.triangles);
