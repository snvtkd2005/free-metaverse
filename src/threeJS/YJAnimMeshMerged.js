 ...
 */
class YJAnimMeshMerged {
  constructor(_this, scene, renderer, texAnim, callback) {
    let scope = this;
    ...
    // const gltfs = ['models/TestScene/fengche001.gltf', 'models/TestScene/fengche001.gltf'];
    // const gltfs = ['models/TestScene/Parrot.glb', 'models/TestScene/Flamingo.glb'];
    const gltfs = ['./public/farm/models/TestScene/Parrot.glb', './public/farm/models/TestScene/Flamingo.glb'];
    ...
    function initBirds(effectController) {
      ...
      m.onBeforeCompile = (shader) => {
        ...
        insert = /* glsl */`
          ...
          vec3 aniPos = texture2D( textureAnimation, 
          vec2( reference.z, mod( time + ( seeds.x ) * ( ( 0.0004 + seeds.y / 10000.0) + normalize( velocity ) / 20000.0 ), reference.w ) ) 
          ).xyz;
