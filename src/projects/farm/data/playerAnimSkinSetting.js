...
export default {
  ...
  avatarData: [
...

    {
      ...
      animationsData: [
        { clipIndex: 0, animName: "idle",isLoop:true, timeScale: 1, connected: false, targetIndex: 0 },
        { clipIndex: 1, animName: "walk",isLoop:true, timeScale: 1, connected: false, targetIndex: 1 },
        { clipIndex: 2, animName: "jump",isLoop:false, timeScale: 1, connected: false, targetIndex: 3 },
        { clipIndex: 3, animName: "floating",isLoop:true, timeScale: 1, connected: false, targetIndex: 4 },
        { clipIndex: 4, animName: "death",isLoop:false, timeScale: 1, connected: false, targetIndex: 2 },
        { clipIndex: 5, animName: "throw",isLoop:true, timeScale: 1, connected: false, targetIndex: 7 },
        { clipIndex: 6, animName: "attack",isLoop:true, timeScale: 1, connected: false, targetIndex: 8 },
        { clipIndex: 7, animName: "collection",isLoop:false, timeScale: 1, connected: false, targetIndex: 6 },
        { clipIndex: 8, animName: "throw2",isLoop:true, timeScale: 1, connected: false, targetIndex: 5 },
        { clipIndex: 9, animName: "sitting",isLoop:false, timeScale: 1, connected: false, targetIndex: 9 },
      ],
      // 扩展动作，由加载外部动画文本解析得到
