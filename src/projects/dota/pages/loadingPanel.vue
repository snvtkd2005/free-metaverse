...
<template>
  ...
  <!-- 加载loading -->
  <div v-if="diplayerLoading" class=" opacity-1 bg-black   absolute w-full h-full top-0 left-0 z-50   text-white">
      ...
      <div class="w-48 h-10 relative flex self-center  mx-auto ">
        <div class="
         absolute
                ...
                ml-4
              ">
          <div v-if="!canEnter" class="mx-auto self-center text-xl">
            {{ loadingProcessValue }}%
          </div>
