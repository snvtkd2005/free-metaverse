...
import { YJBloomScene } from "../../../threeJS/YJBloomScene.js";
import { YJBloomModel } from "../../../threeJS/YJBloomModel.js";
...
export default {
  ...
  methods: {
    init() {
      ...
      // this._YJ3dScene = new YJBloomScene(this.$refs.YJ3dscene, this);
      this._YJ3dScene = new YJBloomModel(this.$refs.YJ3dscene, this);
      this.renderScene();
